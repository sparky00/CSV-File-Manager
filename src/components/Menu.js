const Menu = () => {
  return (
    <nav className="m-0 bg-light-gohan flex flex-col items-start justify-start pt-[51px] px-0 pb-[480px] gap-[39px] text-left text-base text-text font-nunito mq750:pt-[21px] mq750:pb-[203px] mq750:box-border mq1050:pt-[33px] mq1050:pb-[312px] mq1050:box-border">
